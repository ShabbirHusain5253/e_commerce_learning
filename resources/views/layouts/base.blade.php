...
<body class="home-page home-01 ">
					...
					<div class="container">
						...
						<div class="topbar-menu right-menu">
							<ul>
                                ...
                                {{-- TO CHECK WHEATER IF USER IS LOGIN OR NOT --}}
                                @if (Route::has('login'))
                                    @auth
	...
	<script src="https://cdn.tiny.cloud/1/r2xsf1ibx9m4abhwrh00ni6i5lwuqgif3weaeidbt6xs7mu4/tinymce/5/tinymce.min.js" referrerpolicy="origin"></script>
    @livewireScripts
